...
def create_agent():                                                                                                                                                                                      
    ...
    async def get_Ercot_forecast(ctx: RunContext, input_data: ForecastInput) -> str:                                                                                                                    
    ...
    agent = Agent(                                                                                                                                                                                       
        model=model,                                                                                                                                                                                     
        tools=[get_Ercot_forecast],                                                                                                                                                                     
        system_prompt=(                                                                                                                                                                                  
            "You are a helpful forecasting assistant. forecast using the scoring dataset '6971bf6404e148a1b1b17c71' and the deployment '6971b39b3fa6dde87d114a82'"                                                                                                                        
