...
if ercot_dataset_id := os.getenv("ERCOT_DATASET_ID", "698dfe27b04f8da88246bc28"):
    agent_runtime_parameter_values.append(
        pulumi_datarobot.CustomModelRuntimeParameterValueArgs(
            key="ERCOT_DATASET_ID",
            type="string",
            value=ercot_dataset_id,
        )
    )

if ercot_deployment_id := os.getenv("ERCOT_DEPLOYMENT_ID"):
    agent_runtime_parameter_values.append(
        pulumi_datarobot.CustomModelRuntimeParameterValueArgs(
            key="ERCOT_DEPLOYMENT_ID",
            type="string",
            value=ercot_deployment_id,
        )
    )
